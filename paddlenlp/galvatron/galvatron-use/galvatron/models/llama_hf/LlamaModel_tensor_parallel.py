...
class LlamaAttention_tp(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask):
        ...
        # print(f'[graduation] galvatron/models/llama_hf/LlamaModel_tensor_parallel.py: LlamaAttention_tp forward(1) hidden_states.type = {hidden_states.dtype}')
        hidden_states = self.LayerNorm(hidden_states)
        # print(f"[graduation] galvatron/models/llama_hf/LlamaModel_tensor_parallel.py: LlamaAttention_tp forward(2) hidden_states.type = {hidden_states.dtype}")
        ...
        # print(f'[graduation] galvatron/models/llama_hf/LlamaModel_tensor_parallel.py: LlamaAttention_tp forward(3) hidden_states.type = {hidden_states.dtype}')
        hidden_states = hidden_states + input_tensor
        # print(f'[graduation] galvatron/models/llama_hf/LlamaModel_tensor_parallel.py: LlamaAttention_tp forward(4) hidden_states.type = {hidden_states.dtype}')
...
class LlamaMLP_tp(nn.Module):
    ...
    def forward(self, hidden_states):
        # print(f'[graduation] galvatron/models/llama_hf/LlamaModel_tensor_parallel.py: LlamaMLP_tp forward(1) hidden_states.type = {hidden_states.dtype}')
        input_tensor = hidden_states
        hidden_states = self.LayerNorm(hidden_states)
        # print(f'[graduation] galvatron/models/llama_hf/LlamaModel_tensor_parallel.py: LlamaMLP_tp forward(2) hidden_states.type = {hidden_states.dtype}')
        hidden_states, bias = self.mlp(hidden_states)
        # print(f'[graduation] galvatron/models/llama_hf/LlamaModel_tensor_parallel.py: LlamaMLP_tp forward(3) hidden_states.type = {hidden_states.dtype}')
        hidden_states = hidden_states + input_tensor
        # print(f'[graduation] galvatron/models/llama_hf/LlamaModel_tensor_parallel.py: LlamaMLP_tp forward(4) hidden_states.type = {hidden_states.dtype}')
        return hidden_states
