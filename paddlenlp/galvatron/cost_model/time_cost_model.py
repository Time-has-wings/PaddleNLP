...
class TimeCostModel:
    ...
    def estimate_dp_communication_cost(self):
        ...
        self.fsdp_allgather_message_size = self.dp_message_size * 0.5 # [NOTE] 此处可以重新写
    ...
    def estimate_tp_communication_cost(self):
        ...
        if args.mixed_precision_type == 'fp16' or args.mixed_precision_type == 'bf16':  # [NOTE] when paddle use mix_precision, the activation is still in fp32
...
class OtherTimeCostModel:
    ...
    def estimate_tp_time(self):
        ...
        while tp_size <= args.max_tp_size and tp_size * args.pp_size <= args.world_size:
            ...
            tp_message_size = (tp_size - 1) / tp_size * args.mbsz
