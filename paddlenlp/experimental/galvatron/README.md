...
- Load Estimator
Based on data from the performance analyzer, it models the runtime and memory overhead for a given parallel strategy under specific cluster and model configurations. The estimation error is small (typically within 5% on A100 clusters).
