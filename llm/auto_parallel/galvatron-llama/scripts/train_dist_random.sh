...
task_name="A100_2_2_2_zero2_FALSE_128_16_8_4_O1_TRUE_16_1024"
rm -rf output/$task_name/
rm -rf "output/memory_$task_name""_log"
...
LAUNCHER="${LAUNCHER} --log_dir output/memory_$task_name""_log ${TRAINER} --output_dir "./output""
